...
:help
echo Argument 1: fomap file with relative path
echo Argument 2: items and crittes proto id SOURCE folder
echo Argument 3: items and crittes proto id TARGET folder
echo Argument 4: output folder relative path for converted map and logs
...
java -jar foclassic-map-converter.jar -ms %1 -mt %4\%~n1_converted.fomap -ipm %4\items_verbose.mapping -cpm %4\critters.mapping -mph remove -lp out -ll error
